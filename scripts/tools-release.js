...
if (parsedArgs.help) {
  console.log(`
      Usage: yarn tools-release <version> [options]

      Example: "yarn tools-release 1.0.0-beta.1"
...
if (!parsedVersion.isValid) {
  ...
  console.error(
    `Please run "yarn tools-release --help" for details on the acceptable version format.\n`
  );
...
const options = {
  ...
  github: {
     ...
     */
    token: process.env.GITHUB_TOKEN_RELEASE_IT_PLUGIN_TOOLS,
  },
  npm: {
    /**
